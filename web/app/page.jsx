...
export default function Home() {
  ...
  const [joined, setJoined] = useState(null);   // real signup count, from the server

  useEffect(() => {
    fetch("/api/waitlist")
      .then((r) => r.json())
      .then((d) => typeof d.count === "number" && setJoined(d.count))
      .catch(() => {});
  }, []);
  ...
  async function submit(e) {
    ...
    try {
      ...
      setState("done");
      if (!data.alreadyJoined) setJoined((n) => (n === null ? n : n + 1));
    } catch {
